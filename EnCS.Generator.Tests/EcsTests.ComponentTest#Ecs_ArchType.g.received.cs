...
namespace Runner
{
	...
	public static class Ecs_ContainerExtensions
	{
		...
		{
			return Ecs.Wall.FromArchType(ref container.GetValue(ptr), (int)ptr.idx & 7, MeshResourceManager);
		}

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Ecs.Cam Get(this ref IndexedContainer<Ecs.Cam.Vectorized, Ecs.Cam> container, ArchRef<Ecs.Cam> ptr)
		{
			return Ecs.Cam.FromArchType(ref container.GetValue(ptr), (int)ptr.idx & 7);
		}
	}
}